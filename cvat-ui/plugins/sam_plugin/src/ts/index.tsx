...
const samPlugin: SAMPlugin = {
                ...
                async leave(
                    ...
                    const feeds = modelData({
                        ...
                        maskInput: plugin.data.lowResMasks.has(key) ?
                            (plugin.data.lowResMasks.get(key) as Tensor) :
                            null,
                    });
    ...
    data: {
        core: null,
        task: null,
        modelID: 'segment-anything-route',
...
function register(): void {
    if (Object.prototype.hasOwnProperty.call(window, 'cvatUI')) {
        (window as any as { cvatUI: { registerComponent: PluginEntryPoint } }).cvatUI.registerComponent(SAMModelPlugin);
    }
}
