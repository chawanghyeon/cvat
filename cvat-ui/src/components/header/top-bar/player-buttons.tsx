...
function PlayerButtons(props: Props): JSX.Element {
    ...
    return (
        <Col className='cvat-player-buttons'>
            <CVATTooltip title='Go to the first frame' placement='bottom'>
            ...
            <Popover
                ...
                content={(
                    <>
                        <CVATTooltip title={`${prevRegularText}`} placement='bottom'>
                            <Icon
                        ...
                        <CVATTooltip title={`${prevFilteredText}`} placement='bottom'>
                            <Icon
                        ...
                        <CVATTooltip title={`${prevEmptyText}`} placement='bottom'>
                            <Icon
            ...
            >
                <CVATTooltip placement='bottom' title={`${prevButtonTooltipMessage} ${previousFrameShortcut}`}>
                    {prevButton}
                </CVATTooltip>
            </Popover>

            {!playing ? (
                <CVATTooltip title={`Play ${playPauseShortcut}`} placement='bottom'>
                    <Icon className='cvat-player-play-button' component={PlayIcon} onClick={onSwitchPlay} />
                </CVATTooltip>
            ) : (
                <CVATTooltip title={`Pause ${playPauseShortcut}`} placement='bottom'>
            ...
            <Popover
                ...
                content={(
                    <>
                        <CVATTooltip title={`${nextRegularText}`} placement='bottom'>
                            <Icon
                        ...
                        <CVATTooltip title={`${nextFilteredText}`} placement='bottom'>
                            <Icon
                        ...
                        <CVATTooltip title={`${nextEmptyText}`} placement='bottom'>
                            <Icon
            ...
            >
                <CVATTooltip placement='bottom' title={`${nextButtonTooltipMessage} ${nextFrameShortcut}`}>
                    {nextButton}
                </CVATTooltip>
            </Popover>
            ...
            <CVATTooltip title='Go to the last frame' placement='bottom'>
