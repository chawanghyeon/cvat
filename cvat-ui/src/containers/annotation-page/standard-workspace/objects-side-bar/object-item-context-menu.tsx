...
import ObjectItemContextMenu from 'components/annotation-page/standard-workspace/objects-side-bar/object-item-context-menu';
...
class ObjectItemContextMenuContainer extends React.PureComponent<Props> {
    private copy = (): void => {
